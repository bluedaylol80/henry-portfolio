...
## 승인된 변경 (본부장 결재 2026-08-13, 실화면 리뷰 4건)
- **역량 섹션 재구성 허용** — 정본 1의 "확정 카피 수정 금지"에서 **역량만 예외**. 기획/사업/운영/디렉터
  4영역으로 교체하며, 근거는 팩트시트 **§5 역량 4영역 매핑**(2026-08-13 본부장 진술). 히어로·성과·경력 카피는 계속 동결.
- **성과 카드 상세 뷰 신설** · **성과 카드 이미지 슬롯 신설**(팩트시트 §6). 이미지 파일 수집·삽입은
  🔴 사람 전용(저작권 판정) — 루프는 슬롯까지.
- **히어로 보색 레이어 신설** — 리빌 영역에서 텍스트 가독성 유지용 장식 복제본.
