...
/**
 * The /story landing composition — the seven sections only. Its background now
 * comes from the shell-level RoomBackdrop (the shared sleeping-room diorama), so
 * no 3D scene or fallback mounts here (2026-07-13 detail-page redesign, 1차).
 * Preloader, Nav, Cursor, Footer and smooth-scroll live at the shell level too.
 *
 * §10.2 — background dim: a fixed z-[5] scrim (above the backdrop z-[-1], below
 * content z-10) stays transparent while the hero is on screen, then fades in to
 * SCRIM_MAX as the hero scrolls past so downstream sections read against a
 * darker room. Fonts/colors are untouched.
 */
