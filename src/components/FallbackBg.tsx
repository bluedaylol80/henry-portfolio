  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden bg-base" aria-hidden="true">
      <div className="absolute inset-0 animate-bg-drift will-change-transform">
        <div className="absolute inset-0 bg-[radial-gradient(65%_55%_at_16%_14%,rgba(255,180,84,0.12),transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(60%_60%_at_50%_46%,rgba(139,92,246,0.14),transparent_62%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(66%_62%_at_84%_88%,rgba(34,211,238,0.12),transparent_60%)]" />
      </div>
      {/* framing vignette — stays fixed to the viewport */}
      <div className="absolute inset-0 bg-[radial-gradient(135%_135%_at_50%_50%,transparent_50%,rgba(6,7,12,0.92))]" />
    </div>
  )
}
